...
export default function Filter({display}){
    return(
        <div className={`${display?"block":"hidden"} md:block flex flex-row md:flex-col border-black pt-4 md:space-y-4 md:space-x-0 space-x-4 bg-white p-4 mt-2 rounded-md`}>
